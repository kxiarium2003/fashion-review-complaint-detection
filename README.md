...
| Model | Setting | Micro F1 | Macro F1 | Subset Accuracy |
| --- | --- | --- | --- | --- |
| TF-IDF + LinearSVC | coarse 8-label baseline | 0.540 | 0.456 | 0.550|
| Fine baseline | fine 18-label, content_norm, threshold 0.5 | 0.737 | 0.698 | 0.796 
| Fine + Label-wise Threshold | fine 18-label, gold 기준 threshold | 0.774 | 0.756 | 0.816
| TAPT + Fine | TAPT 후 fine 18-label, threshold 0.5 | 0.740 | 0.633 | 0.796
| TAPT + Fine + Label-wise Threshold | final model | 0.798 | 0.803 | 0.838 |
